      ...
      <form method="POST" action="{{ route('restaurant.store') }}" class="mt-4" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="my-2 w-1/2 pr-3">
            <label for="logo" class="label font-medium text-gray-700 block mb-2"> Logo <small>(Ratio 1:1 || Max: 500kb)</small></label>
          ...
          <div class="my-2 w-1/2">
            <label for="banner" class="label font-medium text-gray-700 block mb-2"> Banner <small>(Ratio 3:1 || Max: 1mb)</small></label>
