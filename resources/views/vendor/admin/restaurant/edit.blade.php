       ...
       <div class="flex flex-wrap">
         ...
         <div class="my-2 w-1/2 pr-3">
           ...
           <div class="drop-area" id="drop-area-logo">
             ...
             <img id="preview-logo" src="{{ $restaurant->logo ? Storage::url("restaurant/logos/".$restaurant->logo) : '' }}"
         ...
         <div class="my-2 w-1/2">
           ...
           <div class="drop-area" id="drop-area-banner">
             ...
             <img id="preview-banner" src="{{ $restaurant->banner ? Storage::url("restaurant/banners/".$restaurant->banner) : '' }}"
