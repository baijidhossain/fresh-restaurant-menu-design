    ...
    <div class="py-12">
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight py-4">
                @lang('crud.restaurant_user.edit_title')
            </h2>
            <x-partials.card>
                <x-slot name="title">
                    <a href="{{ route('restaurant_user.index') }}" class="mr-4"
                ...
                <x-form
                    method="PUT"
                    action="{{ route('restaurant_user.update', $restaurant_user) }}"
                    has-files
                    class="mt-4"
                >
                    @include('admin.restaurant_user.form-inputs')
