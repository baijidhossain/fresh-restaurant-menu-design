                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                        <a class="dropdown-item" href="{{ route("profile",$restaurant_user->slug) }}"> <i class="ri-home-5-line"></i> Home</a>
                      </li>
                ...
                <div class="accordion border-0" id="accordionExample">
                  ...
                  <div class="accordion-item custom-accordion-item border-0">
                    ...
                    <h2 class="accordion-header" id="general-info">
                      <button class="accordion-button custom-accordion-button rounded-0 " data-accordion-name="general-information" type="button"
                             ...
                             @csrf
                              ...
                              <div class="mb-3">
                                ...
                                <div class="form-group">
                                  <input type="text" class="form-control" id="name" name="name" maxlength="100"  value="{{ $restaurant->name ?? "" }}" required>
                                </div>
                              ...
                              <div class="mb-3">
                                <label for="phone" class="form-label custom-form-label required-star">Phone <span class="required-indicator">*</span></label>
                                <div class="form-group">
                                  <input type="text" class="form-control" id="phone" name="phone"  maxlength="20" value="{{ $restaurant->phone ?? "" }}" required>
                                  @error('phone')
                                  <p class="text-danger mt-1"> {{ $message }} </p>
                                  @enderror
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="mb-3">
                                    <label for="start" class="form-label custom-form-label required-star">Start Time <span class="required-indicator">*</span></label>
                                    <div class="form-group">
                                      <input type="time" class="form-control" id="start" name="start_time"  value="{{ $restaurant->start_time ? \Carbon\Carbon::parse($restaurant->start_time)->format('H:i') : '' }}" required >
                                ...
                                <div class="col-md-6">
                                  <div class="mb-3">
                                    <label for="end" class="form-label custom-form-label required-star">End Time <span class="required-indicator">*</span></label>
                                    <div class="input-group">
                                      <input type="time" class="form-control" id="end" name="end_time" value="{{ $restaurant->start_time ? \Carbon\Carbon::parse($restaurant->end_time)->format('H:i') : '' }}" required>
                                    </div>
                                    @error('end_time')
                                    <p class="text-danger mt-1">{{ $message }}</p>
                                    @enderror
                  ...
                  <div class="accordion-item  custom-accordion-item border-0">
                    ...
                    <h2 class="accordion-header " id="catalog">
                      <button class="accordion-button custom-accordion-button  rounded-0 collapsed mb-0" data-accordion-name="catalog-items" type="button"
                        ...
                        <div class="_card">
                          <div class="card-header p-2">
                            ...
                            <div class="card-options">
                              <a href="{{ route("account.catalog.create") }}" data-bs-toggle="modal" data-bs-target="#dynamicmodal"
                                ...
                                <tbody>
                                  ...
                                  <tr class="align-middle text-nowrap">
                                    ...
                                    <td class="text-end">
                                      ...
                                      <a  href="{{ route("account.catalog.edit",$catalog->id) }}" data-bs-toggle="modal" data-bs-target="#dynamicmodal"
                  ...
                  <div class="accordion-item custom-accordion-item border-0">
                    <h2 class="accordion-header" id="product">
                      <button class="accordion-button custom-accordion-button collapsed mb-0" data-accordion-name="product-items" type="button"
                      ...
                      <div class="accordion-body p-0 border-0 ">
                        ...
                        <div class="_card">
                          <div class="card-header p-2">
                            ...
                            <div class="card-options">
                              <a href="{{ route("account.catalog.item.create") }}" data-bs-toggle="modal" data-bs-target="#dynamicmodal"
                                class="btn btn-primary  float-end px-3">
                                Add <i class="ri-add-line"></i>
                              </a>
                            </div>
                                ...
                                <tbody>
                                  ...
                                  <tr class="align-middle">
                                    ...
                                    <td class="text-end text-nowrap">
                                      ...
                                      <a  href="{{ route("account.catalog.item.edit",$item->id) }}" data-bs-toggle="modal" data-bs-target="#dynamicmodal"
                  ...
                  <div class="accordion-item custom-accordion-item border-0">
                    <h2 class="accordion-header" id="security">
                      <button class="accordion-button custom-accordion-button collapsed mb-0" data-accordion-name="security" type="button"
                                ...
                                <div class="row mt-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group  mb-4">
                                      ...
                                      <input type="text"
                                        class="form-control bg-body-secondary  @error('phone') is-invalid @enderror"
                                        id="phone" name="phone" placeholder="Phone"
                                        value="{{ $restaurant_user->phone  }}" readonly>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-4 ">
                                      <input type="new-password" class="form-control   @error('new_password') is-invalid @enderror"
                                        id="new-password" name="new_password" placeholder="New Password">
                                      <span class="input-group-text bg-transparent border-start-0 rounded-end-2 toggle-password"
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-4">
                                      ...
                                      <input type="password" class="form-control  @error('new_password_confirmation') is-invalid @enderror"
                                        id="confirm-password" name="new_password_confirmation" placeholder="Confirm Password">
                                      <span class="input-group-text bg-transparent border-start-0 rounded-end-2 toggle-password"
